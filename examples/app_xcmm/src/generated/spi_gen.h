...
struct spi_client_vt {
  void ((*__attribute__((fptrgroup("spi_cvt_group_set"))) set))(spi_client_t, int);
  int ((*__attribute__((fptrgroup("spi_cvt_group_get"))) get))(spi_client_t);
  void ((*__attribute__((fptrgroup("spi_cvt_group_triple"))) triple))(spi_client_t);
  void ((*__attribute__((fptrgroup("spi_cvt_group_add_all"))) add_all))(spi_client_t, unsigned, short, char);
  void ((*__attribute__((fptrgroup("spi_cvt_group_stop"))) stop))(spi_client_t);
  void ((*__attribute__((fptrgroup("spi_cvt_group_begin_transaction"))) begin_transaction))(spi_client_t, unsigned, unsigned, unsigned);
  void ((*__attribute__((fptrgroup("spi_cvt_group_end_transaction"))) end_transaction))(spi_client_t, unsigned);
  char ((*__attribute__((fptrgroup("spi_cvt_group_transfer8"))) transfer8))(spi_client_t, char);
  unsigned ((*__attribute__((fptrgroup("spi_cvt_group_transfer32"))) transfer32))(spi_client_t, unsigned);
};
inline void (client_spi_set)(spi_client_t c, int p0) {
  c->vt->set(c, p0);
}
inline int (client_spi_get)(spi_client_t c) {
  return c->vt->get(c);
}
inline void (client_spi_triple)(spi_client_t c) {
  c->vt->triple(c);
}
inline void (client_spi_add_all)(spi_client_t c, unsigned p0, short p1, char p2) {
  c->vt->add_all(c, p0, p1, p2);
}
inline void (client_spi_stop)(spi_client_t c) {
  c->vt->stop(c);
}
